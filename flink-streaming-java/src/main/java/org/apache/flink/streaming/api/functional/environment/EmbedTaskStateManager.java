...
public class EmbedTaskStateManager implements TaskStateManager {
    ...
    public EmbedTaskStateManager() {
        this(EmbedLocalRecoveryConfig.disabled());
    }

    public EmbedTaskStateManager(LocalRecoveryConfig localRecoveryConfig) {
        this(
                new JobID(),
                new ExecutionAttemptID(),
                new EmbedCheckpointResponder(),
                localRecoveryConfig);
    }

    public EmbedTaskStateManager(JobID jobId, ExecutionAttemptID executionAttemptID) {
        this(jobId, executionAttemptID, null, EmbedLocalRecoveryConfig.disabled());
    }
