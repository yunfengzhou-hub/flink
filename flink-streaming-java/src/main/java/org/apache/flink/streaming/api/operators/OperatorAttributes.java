...
public class OperatorAttributes {
    ...
    /**
     * Returns true if the operator might assign additional timestamps to the output
     * records. False if the operator only forward timestamps of existing input records
     * to the output.
     */
