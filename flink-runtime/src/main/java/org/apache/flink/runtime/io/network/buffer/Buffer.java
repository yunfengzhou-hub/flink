...
public interface Buffer {
    ...
    enum DataType {
        ...
        /**
         * {@link #DATA_BUFFER_WITHOUT_PARTIAL_RECORD} indicates that this buffer represents a
         * non-event data buffer, and that at the end of this buffer there is no data cut and split
         * into the next buffer.
         */
        DATA_BUFFER_WITHOUT_PARTIAL_RECORD(true, false, false, false, false),
