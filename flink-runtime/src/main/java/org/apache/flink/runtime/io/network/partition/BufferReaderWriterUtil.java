...
public final class BufferReaderWriterUtil {
    ...
    private static final short HEADER_VALUE_IS_WITHOUT_PARTIAL_RECORD = 3;

    private static final short HEADER_VALUE_IS_END_OF_DATA = 4;

    private static final short HEADER_VALUE_IS_END_OF_PARTITION = 5;
    ...
    private static short generateDataTypeHeader(Buffer buffer) {
        ...
        } else if (dataType == Buffer.DataType.DATA_BUFFER_WITHOUT_PARTIAL_RECORD) {
            return HEADER_VALUE_IS_WITHOUT_PARTIAL_RECORD;
    ...
    private static Buffer.DataType parseDataTypeHeader(Short dataTypeIndex) {
        ...
        } else if (dataTypeIndex == HEADER_VALUE_IS_WITHOUT_PARTIAL_RECORD) {
            return Buffer.DataType.DATA_BUFFER_WITHOUT_PARTIAL_RECORD;
